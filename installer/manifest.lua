...
--  Version: v2025-10-16-03  (Auto-Fix + Force for Node)
...
local manifest = {
  ...
  -----------------------------------------------------
  shared = {
    { dst="/xreactor/shared/json.lua",
      url="https://raw.githubusercontent.com/ItIsYe/ExtreamReactor-Controller-V2/main/src/shared/json.lua",
      ver="2025-09-12-01" },

    { dst="/xreactor/shared/storage.lua",
      url="https://raw.githubusercontent.com/ItIsYe/ExtreamReactor-Controller-V2/main/src/shared/storage.lua",
      ver="2025-09-12-01" },

    { dst="/xreactor/shared/gui.lua",
      url="https://raw.githubusercontent.com/ItIsYe/ExtreamReactor-Controller-V2/main/src/shared/gui.lua",
      ver="2025-09-12-01" },

    { dst="/xreactor/shared/util.lua",
      url="https://raw.githubusercontent.com/ItIsYe/ExtreamReactor-Controller-V2/main/src/shared/util.lua",
      ver="2025-09-12-01" },
  },

  -----------------------------------------------------
  -- Installer (damit sich der Installer selbst aktualisieren kann)
  -----------------------------------------------------
  installer = {
    { dst="/xreactor/installer.lua",
  ...
  -----------------------------------------------------
  master = {
    { dst="/xreactor/master.lua",
      url="https://raw.githubusercontent.com/ItIsYe/ExtreamReactor-Controller-V2/main/src/master/master.lua",
      ver="2025-10-15-04" },

    { dst="/xreactor/config_master.lua",
      url="https://raw.githubusercontent.com/ItIsYe/ExtreamReactor-Controller-V2/main/src/master/config_master.lua",
      ver="2025-10-15-01" },

    { dst="/xreactor/debug.lua",
      url="https://raw.githubusercontent.com/ItIsYe/ExtreamReactor-Controller-V2/main/src/master/debug.lua",
      ver="2025-10-15-01" },
  },

  -----------------------------------------------------
  -- Node-Rolle
  -- 'force = true' erzwingt den Download, falls Datei fehlt oder leer ist.
  -----------------------------------------------------
  node = {
    { dst="/xreactor/node.lua",
      url="https://raw.githubusercontent.com/ItIsYe/ExtreamReactor-Controller-V2/main/src/node/node.lua",
      ver="2025-10-16-02", force=true },

    { dst="/xreactor/config_node.lua",
  ...
  -----------------------------------------------------
  -- Optional: Autostart (nur wenn du es nutzen willst)
  -----------------------------------------------------
  autosetup = {
    { dst="/startup",
